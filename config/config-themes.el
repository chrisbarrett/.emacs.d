...
(defun config-themes-large-screen ()
  (set-face-attribute 'default nil :height (truncate (* parameters-default-text-height parameters-large-screen-scaling-factor)))
  (set-face-attribute 'variable-pitch nil :height (truncate (* parameters-variable-pitch-text-height parameters-large-screen-scaling-factor))))
