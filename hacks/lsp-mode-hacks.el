...
(autoload 'lsp-clients-flow-tag-file-present-p "lsp-clients")

(el-patch-feature lsp-mode)


(with-eval-after-load 'lsp-clients
  (el-patch-defun lsp-clients-flow-activate-p (file-name _mode)
...
based on FILE-NAME and MAJOR-MODE"
    (or (member mode '((el-patch-add web-js-base-mode web-js-mode web-ts-mode) typescript-mode typescript-tsx-mode js-mode js2-mode rjsx-mode))
